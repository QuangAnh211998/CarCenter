...
public class BottomSheetSelected extends BottomSheetDialogFragment {
    private List<ProvinceModel> provinceModelList;
    private ProvinceAdapter.OnItemOnCLick itemOnCLick;

    public BottomSheetSelected(List<ProvinceModel> provinceModelList, ProvinceAdapter.OnItemOnCLick itemOnCLick) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.layout_bottomsheet_selected, null);
        bottomSheetDialog.setContentView(view);

        recyclerView = view.findViewById(R.id.selected_recyclerView);
