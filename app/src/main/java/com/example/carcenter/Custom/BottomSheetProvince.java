...
public class BottomSheetProvince extends BottomSheetDialogFragment {

    private List<ProvinceModel> provinceModelList;
    private ProvinceAdapter.OnItemOnCLick itemOnCLick;

    public BottomSheetProvince(List<ProvinceModel> provinceModelList, ProvinceAdapter.OnItemOnCLick itemOnCLick) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.layout_bottomsheet_province, null);
        bottomSheetDialog.setContentView(view);

        recyclerView = view.findViewById(R.id.province_recyclerView);
